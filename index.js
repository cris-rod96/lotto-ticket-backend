...
// import { sorteoServices, ticketServices } from './src/services/index.services.js'
...
//           if (cerrados > 0) {
//             console.log(`[SISTEMA]: Se han cerrado ${cerrados} sorteos automáticamente.`)
//           }
//         } catch (error) {
...
//       // Usamos directamente tu método de ticket/update.service.js
//       cron.schedule(
//         '0 0 * * *',
//         async () => {
//           console.log('[SISTEMA]: Iniciando validación de tickets expirados...')
//           try {
//             const resultado = await ticketServices.expirarTicketsPorVencimiento()

//             if (resultado.count > 0) {
//               console.log(`[SISTEMA]: Se han marcado ${resultado.count} tickets como "Expirado".`)
//             }
//           } catch (error) {
